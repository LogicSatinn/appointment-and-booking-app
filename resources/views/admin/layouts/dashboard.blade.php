<x-admin.master-layout>
    <div class="content">
            ...
            <div class="block-content block-content-full">
                <div class="row text-center">
                    ...
                    <div class="col-md-4 py-3">
                        ...
                        <a class="link-fx font-size-sm font-w700 text-uppercase text-muted" href="javascript:void(0)">Expenses
                            Today</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-4 invisible" data-toggle="appear">
                ...
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <em class="font-size-sm text-muted">Active through May 2025</em>
                    </div>
                </a>
                <!-- END Card #1 -->
            </div>
            <div class="col-xl-4 invisible" data-toggle="appear">
                ...
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <em class="font-size-sm text-muted">Active through October 2028</em>
                    </div>
                </a>
                <!-- END Card #2 -->
            </div>
            <div class="col-xl-4 invisible" data-toggle="appear">
                ...
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <em class="font-size-sm text-muted">Active through July 2027</em>
                    </div>
                </a>
                <!-- END Card #3 -->
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 invisible" data-toggle="appear">
                ...
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <em class="font-size-sm text-muted">$1.200,00 in monthly charges</em>
                    </div>
                </a>
                <!-- END Bank Account #1 -->
            </div>
            <div class="col-lg-6 invisible" data-toggle="appear">
                ...
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <em class="font-size-sm text-muted">$2.350,00 in monthly charges</em>
                    </div>
                </a>
                <!-- END Bank Account #2 -->
            </div>
        ...
        <a class="block block-rounded block-link-shadow invisible border-left border-success border-3x"
           data-toggle="appear"
           href="javascript:void(0)">
            ...
            <span
                class="font-size-sm text-muted">From <strong>Company Inc</strong> at <strong>June 10, 2018 - 10:06</strong></span>
            </div>
        </a>
        <a class="block block-rounded block-link-shadow invisible border-left border-danger border-3x"
           data-toggle="appear"
           href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                <div>
            ...
            <div class="block-content block-content-full block-content-sm bg-body-light">
            <span
                class="font-size-sm text-muted">From <strong>Company Inc</strong> at <strong>June 5, 2018 - 08:46</strong></span>
            </div>
        </a>
        <a class="block block-rounded block-link-shadow invisible border-left border-success border-3x"
           data-toggle="appear"
           href="javascript:void(0)">
            ...
            <div class="block-content block-content-full block-content-sm bg-body-light">
            <span
                class="font-size-sm text-muted">From <strong>Company Inc</strong> at <strong>May 25, 2018 - 12:25</strong></span>
            </div>
        </a>
        <a class="block block-rounded block-link-shadow invisible border-left border-success border-3x"
           data-toggle="appear"
           href="javascript:void(0)">
            ...
            <div class="block-content block-content-full block-content-sm bg-body-light">
            <span
                class="font-size-sm text-muted">From <strong>Company Inc</strong> at <strong>May 23, 2018 - 14:23</strong></span>
            </div>
        </a>
        ...
        <div class="text-center invisible" data-toggle="appear">
            <a class="btn btn-sm btn-secondary font-w600" href="javascript:void(0)">
