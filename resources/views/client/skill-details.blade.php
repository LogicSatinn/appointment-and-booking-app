        ...
        <div class="row mb-8">
            <div class="col-lg-12 mb-6 mb-lg-0 position-relative">
                ...
                <div id="schedule" class="mb-8">
                    <ul class="nav course-tab-v1 border-bottom h4 mb-8">
                        <li class="nav-item">
                            <a class="nav-link active" href="#schedule" data-bs-toggle="smooth-scroll"
                               data-bs-offset="0">Schedule</a>
                        </li>
                    </ul>
                                ...
                                <div class="col-md-4 card-zoom position-relative">
                                    ...
                                    <a href="#lala" class="card-img sk-thumbnail img-ratio-2 d-block">
                                        <img class="rounded shadow-light-lg"
                                             src="{{ asset('frontend/img/products/product-15.jpg')}}"
                                             alt="...">
                                    </a>
                            ...
                            <span class="text-white text-uppercase fw-bold font-size-xs">BEST SELLER</span>
                                ...
                                <div class="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                                    ...
                                    <div class="position-relative">
                                        <a href="{{ route('appointmentDetails', $appointment) }}" class="d-block stretched-link"><h4
                                                class="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">{{ $appointment->title }}</h4>
                                        </a>
                                        <ul class="nav mx-n3 mb-3">
                                            ...
                                            <li class="nav-item px-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="font-size-sm">{{ $appointment->start }}
                                                        - {{ $appointment->end }}</div>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="row mx-n2 align-items-center">
                                            <div class="col px-2">
                                                ...
                                                <ins class="h4 mb-0 mb-lg-n1 ms-1">TZS {{ $appointment->price }}</ins>
                                            </div>
