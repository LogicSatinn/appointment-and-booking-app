            ...
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                <div id="Reviews" class="mb-8">
                    <ul class="nav course-tab-v1 border-bottom h4 mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#Reviews" data-bs-toggle="smooth-scroll" data-bs-offset="0">Reviews</a>
                        </li>
                    </ul>
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{ asset('frontend/img/photos/photo-1.jpg')}}" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{ asset('frontend/img/photos/photo-2.jpg')}}" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{ asset('frontend/img/photos/photo-14.jpg')}}" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="course-single-v5.html" class="w-100p d-block me-5">
                                    <img src="{{ asset('frontend/img/photos/photo-16.jpg')}}" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-single-v5.html" class="d-block">
        ...
        <div class="mx-n4 mb-12" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-15.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-14.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-16.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-12.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-13.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-11.jpg')}}" alt="...">
                        </a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="{{ asset('frontend/img/products/product-10.jpg')}}" alt="...">
                        </a>
