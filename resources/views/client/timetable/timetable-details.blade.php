...
{{--                            <ins class="h2 mb-0">{{ $timetable->skill }}</ins>--}}
                        ...
                        @if($timetable->isOnGoing())
                            <button class="btn btn-info btn-block mb-6">
                                {{ \Illuminate\Support\Str::title($timetable->status) }}
                            </button>
                        @endif

                        @if($timetable->isComplete())
                            <button class="btn btn-success btn-block mb-6">
                                {{ \Illuminate\Support\Str::title($timetable->status) }}
                            </button>
                        @endif
