    ...
    var r = function () {
        ...
        return t = e, a = [{
            key: "addEvent", value: function () {
                var e = this, t = jQuery(".js-add-event"), n = "";
            ...
            key: "initEvents", value: function () {
                jQuery(".js-events").find("li").each((function (e, t) {
                    var n = jQuery(t), r = {title: jQuery.trim(n.text()), color: n.css("background-color")};
                    n.data("eventObject", r), n.draggable({zIndex: 999, revert: !0, revertDuration: 0})
                }))
            }
        }, {
            key: "initCalendar", value: function () {
                ...
                jQuery(".js-calendar").fullCalendar({
                    ...
                    drop: function (e, t, n, r) {
                        var a = jQuery(n.helper), i = a.data("eventObject"), l = jQuery.extend({}, i);
